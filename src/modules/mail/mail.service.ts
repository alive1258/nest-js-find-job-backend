...
export class MailService {
  ...
  private readonly OTP_MAX_ATTEMPTS = 99;
  private readonly OTP_BLOCK_HOURS = 1;

  // Company details constants
  private readonly COMPANY_NAME = 'ZKS';
  private readonly LOGIN_URL = 'https://zks.com/login';
  private readonly SUPPORT_EMAIL = 'support@zks.com';
